    ...
    <div className="space-y-6">
      ...
      {items === null ? (
        ...
        <>
          ...
          >
            <h3 className="text-sm font-semibold text-ink">Add a package ({items.length} of {MAX_PACKAGES})</h3>
            ...
            <p className="rounded-xl border border-dashed border-line bg-surface-muted px-4 py-3 text-sm text-muted">
              You have the maximum of {MAX_PACKAGES} packages. Delete one above if you want to add a different one.
            </p>
          )}
        </>
      )}
